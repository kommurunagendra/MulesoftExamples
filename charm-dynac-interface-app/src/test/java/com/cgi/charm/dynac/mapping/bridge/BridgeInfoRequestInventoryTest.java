 ...
 */
public class BridgeInfoRequestInventoryTest extends XsltTest {

	public BridgeInfoRequestInventoryTest() {
		super("xslt/bridge/bridge_info_request_inventory.xsl");
	}
	...
	public void shouldTestInventoryRequest() {
		expectTransformResult("messages/bridge/deviceInventoryRequestMsg_inventory.xml", "messages/bridge/bridge_info_request_inventory.xml");
	}
}
