 ...
 */
public class DetectorCatInfoRequestDataTest extends XsltTest {
	public DetectorCatInfoRequestDataTest() {
		super("xslt/detector_cat/transformToInfoRequestDataCDM.xsl");
	}
	...
	public void shouldTestSubscription() {
		expectTransformResult("messages/detector_cat/detectorDataRequestMsg.xml","messages/detector_cat/detector_cat_info_request_data.xml");
	}
}