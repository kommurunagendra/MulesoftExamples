...
<xsl:param name="password" />
	...
	<xsl:template match="/hardshoulder:hardshoulder_status_subscription">
		...
		<tmdd:trafficNetworkInformationSubscriptionMsg
			...
			<network-information-type>hard shoulder status</network-information-type>

			<xsl:if test="hardshoulder_spec">
			...
			<c2cMsgAdmin>
				<!--Optional: -->
				<informationalText>hard shoulder status subscription</informationalText>
				<returnAddress>
				...
				<subscriptionID>
					<xsl:value-of
						select="hardshoulder:subscription_config/hardshoulder:subscription_id/hardshoulder:uuid" />
				</subscriptionID>
				<subscriptionName>
					<xsl:value-of
